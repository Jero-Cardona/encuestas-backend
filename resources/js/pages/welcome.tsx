        ...
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px]  lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 font-semibold text-lg">Bienvenido a nuestra micro-app de encuestas!</h1>
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                Para responder la encuesta y consultar sus resultados, por favor inicia sesión en la aplicación. Si no tienes una cuenta, regístrate.
                                <br /><br />
                                Este proyecto fue realizado por:
                                <br />
                            </p>
                            <a className='text-xsm underline underline-offset-4' href='https://portafolio-jeronimo-cardona.vercel.app/'>
                                Jeronimo Cardona Henao
                            </a>
                        </div>
                        <div className="relative flex-1 bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h2 className="mb-1 font-semibold text-lg">Tecnologias implementadas:</h2>
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                A continuacion un listado del stack que se implemento en este proyecto, junto a sus respectivas versiones.
                            </p>
                            <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-4 mt-5'>
                            <span className='inline-flex px-3 py-1 text-black dark:text-white text-xsm rounded-full bg-gray-300 dark:bg-[#948979] items-center'>
                                <svg xmlns="http://www.w3.org/2000/svg" className='mr-2' width={15} height={15} preserveAspectRatio="xMidYMid" viewBox="0 0 256 264"><path d="m255.9 59.6.1 1.1v56.6c0 1.4-.8 2.8-2 3.5l-47.6 27.4v54.2c0 1.4-.7 2.8-2 3.5l-99.1 57-.7.4-.3.1c-.7.2-1.4.2-2.1 0l-.4-.1-.6-.3L2 206c-1.3-.8-2.1-2.2-2.1-3.6V32.7l.1-1.1.2-.4.3-.6.2-.4.4-.5.4-.3c.2 0 .3-.2.5-.3L51.6.6c1.3-.8 2.9-.8 4.1 0L105.3 29c.2 0 .3.2.4.3l.5.3c0 .2.2.4.3.5l.3.4.3.6.1.4.2 1v106l41.2-23.7V60.7c0-.4 0-.7.2-1l.1-.4.3-.7.3-.3.3-.5.5-.3.4-.4 49.6-28.5c1.2-.7 2.8-.7 4 0L254 57l.5.4.4.3.4.5.2.3c.2.2.2.5.3.7l.2.3Zm-8.2 55.3v-47l-17.3 10-24 13.7v47l41.3-23.7Zm-49.5 85v-47l-23.6 13.5-67.2 38.4v47.5l90.8-52.3ZM8.2 39.9V200l90.9 52.3v-47.5l-47.5-26.9-.4-.4c-.2 0-.3-.1-.4-.3l-.4-.4-.3-.4-.2-.5-.2-.5v-.6l-.2-.5V63.6L25.6 49.8l-17.3-10Zm45.5-31L12.4 32.8l41.3 23.7 41.2-23.7L53.7 8.9ZM75 157.3l24-13.8V39.8l-17.3 10-24 13.8v103.6l17.3-10ZM202.3 36.9 161 60.7l41.3 23.8 41.3-23.8-41.3-23.8Zm-4.1 54.7-24-13.8-17.3-10v47l24 13.9 17.3 10v-47Zm-95 106 60.6-34.5 30.2-17.3-41.2-23.8-47.5 27.4L62 174.3l41.2 23.3Z" fill="#FF2D20"/></svg>
                                Laravel 12.20
                            </span>
                            <span className='inline-flex px-3 py-1 text-black dark:text-white text-xsm rounded-full bg-gray-300 dark:bg-[#948979] items-center'>
                                <svg 
